...
CREATE INDEX "product.user_id_index" ON "products" USING btree ("userId");--> statement-breakpoint
CREATE INDEX "user_subscriptions.clerk_user_id_index" ON "user_subscriptions" USING btree ("user_id");